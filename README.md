...
``
sudo apt-get install python-dev python-matplotlib ipython[all] python-pandas python-numpy python-sklearn python-scikit-learn && sudo pip install "ipython[notebook]" markupsafe pyzmq certifi jsonschema numpy scipy   
``
